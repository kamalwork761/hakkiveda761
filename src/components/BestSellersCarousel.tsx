...
export const BestSellersCarousel: React.FC = () => {
  ...
  return (
    <section id="bestsellers" className="py-12 sm:py-16 bg-[#0E281C] text-white relative overflow-hidden border-b border-white/10">
      {/* Toast Notification */}
      {addedToast && (
        ...
        <div className="flex items-end justify-between mb-8 pb-4 border-b border-white/10">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-[var(--brand-gold)] hover:text-[#0E281C] hover:border-[var(--brand-gold)] transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--brand-gold)]"
                ...
                <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3">
                  <div>
                    ...
                    <div className="flex items-center justify-between text-[11px] font-sans text-slate-500 mb-1">
                      <span className="font-semibold uppercase text-[#123F2B] tracking-wider">
                        {product.category}
                      </span>
                    ...
                    <h3
                      onClick={() => openQuickView(product)}
                      className="font-serif-luxury font-bold text-sm sm:text-base text-slate-900 line-clamp-2 hover:text-[#123F2B] transition-colors cursor-pointer leading-snug"
                    >
                      {product.name}
                    </h3>
                  ...
                  <div className="pt-2 border-t border-slate-100 space-y-3">
                    <div className="flex items-baseline gap-2">
                      <span className="text-base font-extrabold text-[#123F2B] font-sans">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="w-full py-2 px-2 bg-[#123F2B] hover:bg-[#0E281C] text-white rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer shadow-sm active:scale-95"
                      >
                      ...
                      <button
                        ...
                        className="w-full py-2 px-2 bg-[var(--brand-gold)] hover:bg-[#b8891e] text-[#123F2B] rounded-lg text-xs font-bold flex items-center justify-center transition-colors cursor-pointer active:scale-95 shadow-sm"
                      >
                        Buy Now
                      </button>
                    </div>
