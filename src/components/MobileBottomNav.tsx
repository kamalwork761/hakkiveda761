...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[var(--brand-primary-deep)]/95 backdrop-blur-lg border-t border-[var(--brand-gold)]/30 shadow-[0_-5px_20px_rgba(0,0,0,0.5)] px-2 py-2 font-sans">
      <div className="flex items-center justify-around max-w-md mx-auto">
        {/* Home */}
        <button
          onClick={() => handleScrollTo('hero')}
          className="flex flex-col items-center justify-center gap-1 text-slate-300 hover:text-[var(--brand-gold)] active:scale-95 transition-all p-1"
          aria-label="Home"
        >
        ...
        <button
          ...
          className="flex flex-col items-center justify-center gap-1 text-[var(--brand-gold)] hover:text-white active:scale-95 transition-all p-1 relative"
        ...
        <button
          ...
          className="flex flex-col items-center justify-center gap-1 text-slate-300 hover:text-[var(--brand-gold)] active:scale-95 transition-all p-1 relative"
          aria-label="Wishlist"
        >
