...
export const INITIAL_PAYMENT_LOGS: PaymentLog[] = [
  {
    ...
    amountINR: 2499,
    status: 'SUCCESSFUL',
    transactionId: 'pay_Rzp9821938102',
    paymentMethodDetails: 'HDFC Credit Card (**** 9812)',
    createdAt: '2026-07-28 08:30 AM',
  },
  {
    id: 'paylog-1002',
    orderId: 'ord-1002',
    ...
    customerEmail: 'priya.nair@singapore.com',
    gateway: 'STRIPE',
    amount: 40,
    currency: 'SGD',
    amountINR: 2499,
    status: 'SUCCESSFUL',
    transactionId: 'ch_3M012938192831',
    paymentMethodDetails: 'DBS Visa Card (**** 4242)',
    createdAt: '2026-07-27 04:15 PM',
  },
  {
    id: 'paylog-1003',
    orderId: 'ord-1003',
    orderNumber: 'HV-901823',
    customerName: 'Aarav Gupta',
    customerEmail: 'aarav.gupta@outlook.com',
    gateway: 'UPI',
    amount: 1899,
    currency: 'INR',
    amountINR: 1899,
    status: 'SUCCESSFUL',
    transactionId: 'upi_gpay_99182371928',
    paymentMethodDetails: 'Google Pay VPA (aarav@okaxis)',
    createdAt: '2026-07-27 11:20 AM',
  },
  {
    id: 'paylog-1004',
    orderId: 'ord-1004',
    orderNumber: 'HV-661298',
    customerName: 'Sarah Al-Maktoum',
    customerEmail: 'sarah.al@dubai.ae',
    gateway: 'PAYPAL',
    amount: 350,
    currency: 'AED',
    amountINR: 7980,
    status: 'SUCCESSFUL',
    transactionId: 'PP-PAY-881923719',
    paymentMethodDetails: 'PayPal Express Wallet (sarah@dubai.ae)',
    createdAt: '2026-07-26 07:40 PM',
  },
  {
    id: 'paylog-1005',
    orderId: 'ord-1005',
    orderNumber: 'HV-551029',
    customerName: 'Vikram Joshi',
    customerEmail: 'vjoshi@gmail.com',
    gateway: 'PHONEPE',
    amount: 999,
    currency: 'INR',
    amountINR: 999,
    status: 'FAILED',
    transactionId: 'TXN_PHONEPE_FAIL_991',
    paymentMethodDetails: 'PhonePe App UPI Intent',
    errorMessage: 'User cancelled transaction in PhonePe app before passcode entry.',
    createdAt: '2026-07-26 02:10 PM',
  },
  {
    id: 'paylog-1006',
    orderId: 'ord-1006',
    orderNumber: 'HV-330192',
    customerName: 'Ananya Verma',
    customerEmail: 'ananya.v@yahoo.co.in',
    gateway: 'COD',
    amount: 3200,
    currency: 'INR',
    amountINR: 3200,
    status: 'PENDING',
    transactionId: 'COD_HV_330192',
    paymentMethodDetails: 'Cash on Delivery (Pending Courier Verification)',
